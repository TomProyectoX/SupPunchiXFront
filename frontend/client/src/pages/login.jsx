  ...
  return (
    <div className="bg-[#0A0A0A] text-[#e5e2e1] h-screen w-full flex flex-col font-sans overflow-hidden selection:bg-[#CCFF00] selection:text-black">
      ...
      <div className="w-full flex items-center px-6 h-16 z-50">
        <Link to="/" className="inline-flex items-center gap-2 text-[#CCFF00] font-headline-md text-xs uppercase tracking-[0.2em] hover:text-white transition-colors group">
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#141414] p-8 lg:p-12 border border-[#262626] relative overflow-hidden shadow-2xl">
              ...
              <header className="mb-10">
                <h1 className="text-3xl font-black uppercase italic tracking-tight text-white">INICIAR SESIÓN</h1>
                ...
                <div className="pt-4 space-y-6">
                  ...
                  <div className="text-center">
                    <p className="text-sm text-[#c4c9ac]">
                      ...
                      <Link to="/register" className="text-white font-bold border-b border-[#CCFF00] ml-2 hover:text-[#CCFF00] transition-colors">
                        REGISTRATE AQUÍ
                      </Link>
                    </p>
                  </div>

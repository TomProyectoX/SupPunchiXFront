...
const getOrderTotal = (orden) => {
  // Si la orden ya fue pagada y tiene monto registrado, lo usamos directamente
  if (orden.montoPagado != null) return orden.montoPagado;
  // Si todavía está en curso, calculamos desde los detalles
              ...
              <article key={orden.id} className="rounded-2xl border border-[#262626] bg-[#111111] p-6">
                <div className="flex flex-col gap-4 border-b border-[#262626] pb-5 md:flex-row md:items-start md:justify-between">
                  ...
                  <div className="flex flex-col gap-3 md:items-end">
                    ...
                    {/* Mostrar descuento si hubo uno aplicado */}
                    {descuento > 0 && (
